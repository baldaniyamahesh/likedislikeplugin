...
if( !function_exists('wpac_plugin_scripts')) {
    function wpac_plugin_scripts() {
        ...
        //Plugin Frontend JS
        wp_enqueue_script('wpac-js', WPAC_PLUGIN_DIR. 'assets/js/main.js', 'jQuery', '1.4.1', true );

        //Plugin Ajax JS
        wp_enqueue_script('wpac-ajax', WPAC_PLUGIN_DIR. 'assets/js/ajax.js', 'jQuery', '1.4.1', true );
